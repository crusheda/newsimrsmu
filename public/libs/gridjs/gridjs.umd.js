!function(t, n) {
    ...
    function j(t, n, e, r, o) {
        ...
        t: if ("style" === n)
            if ("string" == typeof e)
                ...
                r)
                    for (n in r)
                        e && n in e || O(t.style, n, "");
                if (e)
                    for (n in e)
                        r && e[n] === r[n] || O(t.style, n, e[n])
            }
        else if ("o" === n[0] && "n" === n[1])
    ...
    function M(t, n, e, r, o, i, u, s, a) {
        ...
        try {
            t: if ("function" == typeof E) {
                ...
                n.__e = e.__e) : n.__e = F(e.__e, n, e, r, o, i, u, a);
            (l = f.diffed) && l(n)
        } catch (t) {
            n.__v = null,
            (a || null != i) && (n.__e = s,
    ...
    function q(t, n, e) {
        ...
        i = [],
        M(n, t = (!r && e || n).__k = x(P, null, [t]), o || v, v, void 0 !== n.ownerSVGElement, !r && e ? [e] : o ? null : n.firstChild ? c.call(n.childNodes) : null, i, !r && e ? e : o ? o.__e : n.firstChild, r),
        R(i, t)
    }
    function z() {
    ...
    function Y(t, n) {
        ...
        if (t.hasOwnProperty("constructor") && n.hasOwnProperty("constructor") && t.hasOwnProperty("props") && n.hasOwnProperty("props") && t.hasOwnProperty("key") && n.hasOwnProperty("key") && t.hasOwnProperty("ref") && n.hasOwnProperty("ref") && t.hasOwnProperty("type") && n.hasOwnProperty("type"))
    ...
    function Dt() {
        var t, n = gt(void 0), e = n[0], r = n[1], o = It(), i = o.search, u = At(), s = jt().dispatch, a = Ht(function(t) {
            return t.search
        });
        yt(function() {
            e && e.setProps({
    ...
    function Ft() {
        ...
        yt(function() {
            ...
            v.current instanceof Rt ? t.pipeline.on("afterProcess", function(t) {
                return S(t.length)
        ...
        var C = function(t) {
            m && t !== v.current && (b(0),
            0 !== v.current.props.page && v.current.setProps({
                page: 0
            }))
        }
          , E = function() {
    ...
    function wn(t) {
        ...
        yt(function() {
            if (l) {
                ...
                e ? (0 === u && (e.direction = null != (n = t.direction) ? n : 1),
                s(e.direction)) : s(0)
            }
        }, [l]),
        yt(function() {
