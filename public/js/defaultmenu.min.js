...
function setNavActive() {
    ...
    document.querySelectorAll(".side-menu__item").forEach((e) => {
        ...
        if (href === currentPath) {
            ...
            let li = e.closest('li.slide');
            li.classList.add('active');

            let parentUl = li.closest('ul.slide-menu');

            while (parentUl) {

                let parentLi = parentUl.closest('li.has-sub');

                if (parentLi) {
                    parentLi.classList.add('active');
                    parentLi.classList.add('open');

                    let parentA = parentLi.querySelector(':scope > a.side-menu__item');
                    if (parentA) parentA.classList.add('active');

                    parentUl.style.display = 'block';
                }

                parentUl = parentLi?.closest('ul.slide-menu');
            }
        }
    });
}
