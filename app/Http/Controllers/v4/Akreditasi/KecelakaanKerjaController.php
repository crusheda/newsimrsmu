...
namespace App\Http\Controllers\v4\Akreditasi;
...
class KecelakaanKerjaController extends Controller
{
    ...
    {
        return view('pages.v4.akreditasi.kecelakaankerja.index');
    }
    ...
    function tambah() {
        ...
        return view('pages.v4.akreditasi.kecelakaankerja.tambah')->with('list', $data);
    }
    ...
    function ubah($id) {
        ...
        return view('pages.v4.akreditasi.kecelakaankerja.ubah')->with('list', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('v4.akreditasi.kecelakaankerja')->with('message','Tambah Laporan Kecelakaan Kerja Berhasil.');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('v4.akreditasi.kecelakaankerja')->with('message','Perubahan Laporan Kecelakaan Kerja Berhasil.');
    }
