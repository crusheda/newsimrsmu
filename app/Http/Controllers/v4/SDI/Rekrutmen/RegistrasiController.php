...
namespace App\Http\Controllers\v4\SDI\Rekrutmen;
...
class RegistrasiController extends Controller
{
    ...
    {
        if (
                Auth::user()->can('admin_kepegawaian') ||
                Auth::user()->can('admin_kepegawaian_kepala')
            ) {
            ...
            return view('pages.v4.sdi.rekrutmen.registrasi')->with('list', $data);
        } else {
