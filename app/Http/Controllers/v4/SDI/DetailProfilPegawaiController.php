...
class DetailProfilPegawaiController extends Controller
{
    // FUNCTION TABLE
    function index($id) // TAMPILAN HALAMAN DETAIL PROFIL KEPEGAWAIAN
    {
        return view('pages.v4.sdi.profilpegawai.detail.index')->with([
            'id_pegawai' => $id,
        ]);
    }
