...
namespace App\Http\Controllers\v4\Publik\IPSRS;
...
class PerbaikanIPSRSController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        $user_id = $user->id;
        if (Auth::user()->can('admin_perbaikan_ipsrs')) {
            ...
            return view('pages.v4.publik.ipsrs.perbaikan.index-admin')->with('list', $data);
        }else {
            ...
            $totalDikerjakan = perbaikan_ipsrs::where('user_id', $user_id)->whereNotNull('tgl_dikerjakan')->where('tgl_selesai', null)->where('ket_penolakan', null)->count();
            ...
            return view('pages.v4.publik.ipsrs.perbaikan.index-user')->with('list', $data);
        }
    }
    ...
    {
        return view('pages.v4.publik.ipsrs.perbaikan.riwayat');
    }
