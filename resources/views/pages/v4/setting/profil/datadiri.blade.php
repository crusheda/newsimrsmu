    ...
    function loadDataDiri() {
        $.ajax({
            ...
            beforeSend: function () {
                ...
                // $('#status_akun').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#pengalaman_kerja').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#nip').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#nik').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#email').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#hp').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#fb').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#ig').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#tt').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#nama_lengkap').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#nick').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#temp_lahir').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#tgl_lahir').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#jk').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#sk').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#alamat_ktp').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#alamat_dom').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#list_pendidikan').empty().append(`<li class="text-muted">Memuat Data Pendidikan <i class="fas fa-sync-alt fa-spin ms-1"></i></li>`)
                // $('#rp').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#rpk').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#rpo').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
                // $('#ro').empty().append(`<i class="fas fa-sync-alt fa-spin ms-1"></i>`)
