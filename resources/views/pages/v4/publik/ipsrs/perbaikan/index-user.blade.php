...
@section('content')
            ...
            <div class="col-lg-12 col-md-12">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between py-3">
                                <h6 class="mb-0 card-title flex-grow-1">Form <b class="text-success">Tambah</b></h6>
                                <h6 class="mb-0 text-end flex-grow-1 fs-13">Isian (<a class="text-danger">*</a>) Wajib Diisi</h6>
                            </div>
                            <div class="card-body">
                                <form method="POST" id="formTambah" action="{{ route('v4.publik.ipsrs.perbaikan.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="lokasi" id="clr_lokasi"
                                            class="form-control autocomplete" placeholder="Teks Otomatis"
                                            required />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="defaultFormControlInput" class="form-label">Perbaikan <a class="text-danger">*</a></label>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="defaultFormControlInput" class="form-label">Lampiran (<b class="text-warning">Optional</b>) : </label>
                                        ...
                                        <div class="alert alert-light shadow-sm">
                                            <small>
                                                ...
                                                <i class="fa-fw fas fa-caret-right nav-icon"></i> Pastikan upload Foto / Gambar <b class="text-danger">Bukan Video</b>, berformat <b><i>jpg,png,jpeg</i></b>
                                            </small>
                                        </div>
                                        <center>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="btn-group">
                                            <button class="btn btn-primary" onclick="simpan()" id="btn-simpan" type="submit">
                                                <i class="fa-fw fas fa-send-plane nav-icon"></i> Kirim Pengaduan
                                            </button>
                                </form>
                                            <button class="btn btn-warning-transparent" onclick="clearInp()" type="button">
                    ...
                    <div class="col-md-8">
                        @if (count($list['recent']) > 0)
                            <div class="card custom-card">
                                <div class="card-header d-flex align-items-center justify-content-between py-3">
                                    <h6 class="mb-0 card-title flex-grow-1">Perbaikan Berjalan <span class="badge text-bg-secondary">{{ count($list['recent']) }}</span></h6>
                                </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header d-flex align-items-center justify-content-between py-3">
                                <h6 class="mb-0 card-title flex-grow-1">Riwayat <b class="text-primary">Perbaikan</b></h6>
                                <div class="flex-shrink-0">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-warning-transparent" id="btn-refresh" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true"
                                            title="Refresh Tabel Riwayat Perbaikan IPSRS" onclick="refresh()">
                            ...
                            <div class="card-body">
                                <div class="alert alert-light shadow-sm">
                                    <small>
                                        <i class="ti ti-arrow-narrow-right text-primary me-1"></i> Data default yang ditampilkan dibatasi <b>100 data</b> perbaikan terakhir saja <br>
                                        ...
                                        <i class="ti ti-arrow-narrow-right text-primary me-1"></i> Untuk sementara waktu, hak akses untuk <b class="text-orange">Monitoring Perbaikan Per Unit/Bagian</b> hanya dapat dilakukan oleh Atasan Langsung
                                    </small>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-light shadow-sm">
                        <small>
                            Apabila laporan sudah berada pada status <b class="text-primary">DITERIMA</b> oleh IPSRS,
                            anda tidak dapat lagi mengubah ataupun menghapus laporan ini.
                        </small>
                    </div>
                    <div class="form-group mb-3">
                        <label for="defaultFormControlInput" class="form-label">Lokasi <a class="text-danger">*</a></label>
                        <input type="text" id="lokasi_edit" class="form-control autocomplete" placeholder="Masukkan Lokasi" autocomplete="off" required />
                    </div>
                    <div class="form-group mb-3">
        ...
        <div class="modal-dialog modal-simple modal-add-new-address modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p style="text-align: justify;">Anda akan menghapus pengaduan <b>ID:<strong><a id="show_id_hapus"></a></strong></b> tersebut. Lakukanlah dengan hati-hati. Ceklis dibawah untuk melanjutkan penghapusan.</p>
                    <label class="switch">
    ...
    <div class="modal fade" id="modalTrack" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Tracking <kbd>ID : <a id="show_id_track"></a></kbd></h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                    ...
                    <div class="alert alert-light shadow-sm mb-3">
                        <small><b># Klik tombol <b class="text-warning"><u>Status Pengerjaan</u></b> untuk melihat detail pengerjaan oleh IPSRS</b></small>
                    </div>
                    <div class="collapse" id="showDikerjakan">
                        <div class="card table-card">
                            <div class="card-header d-flex align-items-center justify-content-between py-3">
                                <h6 class="mb-0 card-title flex-grow-1"><i class="fa-fw fas fa-caret-right nav-icon me-1"></i> Tabel Status <a class="text-primary">Dikerjakan</a></h6>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            new autoComplete({
                ...
                data: {
                    src: async (query) => {
                        const response = await fetch(
                            `/api/v4/publik/perbaikan/ipsrs/lokasi?lokasi=${encodeURIComponent(query)}`
                        );
                ...
                events: {
                    input: {
                        selection: (event) => {
                            $(".autocomplete").val(event.detail.selection.value);
                        }
                    }
                }
            });
        ...
        function refresh() {
            ...
            $.ajax({
                url: "/api/v4/publik/perbaikan/ipsrs/user/table",
                type: 'GET',
                dataType: 'json',
                        ...
                        content = `<tr><td><div class="d-flex align-items-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="javascript:void(0);" onclick="track(${item.id})" class="dropdown-item text-primary"><i class='fas fa-search me-1'></i> Track</a>`;
                        if (item.tgl_selesai == null) {
                            if (item.tgl_diterima != null) {
                                ...
                                if (item.filename_pengaduan != null || item.filename_pengaduan != '') {
                                    content += `<a href="javascript:void(0);" onclick="showLampiran(${item.id})" class="dropdown-item text-info"><i class='fas fa-image me-1'></i> Lampiran</a>`;
                                } else {
                                    content += `<a href="javascript:void(0);" class="dropdown-item disabled"><i class='fas fa-image me-1'></i> Lampiran</a>`;
                                }
                                content += `<a href="javascript:void(0);" class="dropdown-item disabled"><i class='fas fa-trash-alt me-1'></i> Hapus</a>`;
                            } else {
                                content += `<a href="javascript:void(0);" onclick="ubah(${item.id})" class="dropdown-item text-warning"><i class='fas fa-edit me-1'></i> Ubah</a>`;
                                if (item.filename_pengaduan != null || item.filename_pengaduan != '') {
                                    content += `<a href="javascript:void(0);" onclick="showLampiran(${item.id})" class="dropdown-item text-info"><i class='fas fa-image me-1'></i> Lampiran</a>`;
                                } else {
                                    content += `<a href="javascript:void(0);" class="dropdown-item disabled"><i class='fas fa-image me-1'></i> Lampiran</a>`;
                                }
                                content += `<a href="javascript:void(0);" onclick="hapus(${item.id})" class="dropdown-item text-danger"><i class='fas fa-trash-alt me-1'></i> Hapus</a>`;
                            }
                        } else {
                            content += `<a href="javascript:void(0);" class="dropdown-item disabled"><i class='fas fa-edit me-1'></i> Ubah</a>`;
                            if (item.filename_pengaduan != null || item.filename_pengaduan != '') {
        ...
        function track(id) {
            ...
            $.ajax(
            {
                url: "/api/v4/publik/perbaikan/ipsrs/user/track/"+id,
                type: 'GET',
                dataType: 'json', // added data type
                success: function(res) {
                    $('#track_pengaduan').empty().append(`<a class="text-info fs-16">Keterangan</a> : <br>`+res.show.ket_pengaduan);
                    ...
                    if (res.show.ket_penolakan == null) {
                        content2 = `<tr style="font-size: 13px">
                                    ...
                                    <tr style="font-size: 13px">
                                        <th>
                                            <button class="btn btn-link text-warning btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#showDikerjakan">
                                                <i class="fa-fw fas fa-caret-right nav-icon me-1"></i> <b class="fs-14">STATUS PENGERJAAN</b>
                                            </button>
                                        </th>
                                        <td>
                    ...
                    if (res.catatan != null && res.catatan != '') {
                        res.catatan.forEach(val => {
                            content3 = `<tr style="font-size: 13px">
                                            ...
                                            <td>
                                                <center>
                                                        <button class="btn btn-success btn-sm" onclick="${val.title?"window.location.href='/v4/publik/perbaikan/ipsrs/lampiran/catatan/"+val.id+"'":''}" ${val.title?'':'disabled'}>
        ...
        function ubah(id) {
            ...
            $.ajax(
            {
                url: "/api/v4/publik/perbaikan/ipsrs/user/ubah/"+id,
                type: 'GET',
                dataType: 'json', // added data type
                success: function(res) {
        ...
        function prosesUbah() {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "/v4/publik/perbaikan/ipsrs/user/ubah",
                data: fd,
                contentType: false,
                processData: false,
                dataType: 'json',
        ...
        function prosesHapus() {
            ...
            if (checkboxHapus == false) {
                ...
                $.ajax({
                    ...
                    url: "/api/v4/publik/perbaikan/ipsrs/user/hapus/"+id,
                    type: 'DELETE',
                    success: function(res) {
                        iziToast.success({
                            title: 'Pesan Sukses!',
        ...
        function showLampiran(id) {
            Swal.fire({
                ...
                // text: '',
                imageUrl: '/v4/publik/perbaikan/ipsrs/' + id,
                // imageWidth: 400,
                heightAuto: true,
                imageHeight: 275,
                imageAlt: 'Lampiran',
                ...
                if (result.isConfirmed) {
                    window.location.href = "/v4/publik/perbaikan/ipsrs/" + id;
                }
            })
        }
        ...
        function simpan() {
            $("#formTambah").one('submit', function() {
                ...
                $("#btn-simpan").find("i").toggleClass("fa-send-plane fa-spinner fa-spin");
