...
@section('content')
    ...
    <div class="container-fluid page-container main-body-container">
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Daftar <b class="text-info link-underline-info text-decoration-underline">Peserta Registrasi</b>
                </h1>
            ...
            <div class="col-sm-12">
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        <h6 class="mb-0">Filter <b class="text-primary">Data</b></h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="text-end btn-page mt-3">
                                    <button class="btn btn-link text-dark" id="btn-clear" onclick="clearForm()">Kosongkan</button>
        ...
        <div class="row justify-content-center" id="tablePeserta" hidden>
            <div class="col-sm-12">
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        <h6 class="mb-0">Tabel <b class="text-success">Peserta</b></h6>
                        <div class="btn-group">
                            <button type="button" class="btn btn-warning" id="btn-refresh" onclick="filter()"><i class="ri-refresh-line"></i></button>
                            <button type="button" class="btn btn-info" onclick="window.location='{{ route('v4.sdi.rekrutmen.pengumuman') }}'"><i class="ri-archive-stack-line me-1"></i> Lihat Lowongan</button>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="dttable" class="table table-hover dt-responsive align-middle">
                                ...
                                <tbody id="tampil-tbody">
                                    <tr>
                                        <td colspan="18" style="font-size:13px">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="preview"><span class="badge text-bg-info">Preview</span> | Dokumen : <a id="nama_dokumen" class="text-primary"></a></h6>
    ...
    <div id="formHasil" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="preview">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Form <b class="text-primary">Penentuan Hasil</b> <span class="badge text-bg-primary" id="id_hasil"></span></h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-3">
    ...
    <script>
        ...
        function filter() {
            ...
            const btnFilter = $('#btn-fitler');
            $.ajax(
                {
                    url: "/api/v4/sdi/rekrutmen/registrasi/table/"+id,
                    type: 'GET',
                    ...
                    beforeSend: function() {
                        ...
                        $("#tampil-tbody").empty();
                        $("#tampil-tbody").empty().append(`<tr><td colspan="18" style="font-size:13px"><center><i class="fa fa-spinner fa-spin fa-fw"></i> Memproses data...</center></td></tr>`);
                    },
            ...
            if (hasil == hasil_old) {
                ...
                if (ket == '') {
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        url: `/api/v4/sdi/rekrutmen/registrasi/hasil`,
                        contentType: false,
                        processData: false,
                        dataType: 'json',
                        data: save,
