        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none d-flex align-items-center">
                    Jadwal <b class="text-primary link-underline-primary text-decoration-underline ms-1">Dinas</b> <span class="badge bg-warning-transparent ms-2">Ubah</span>
                </h1>
            ...
            <div class="col-sm-12">
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        <h5 class="mb-0"><button class="btn btn-teal-transparent" onclick="window.location='{{ route('v4.sdi.jadwaldinas') }}'"><i class="fas fa-chevron-left me-2"></i>Kembali</button></h5>
                        <div class="text-end">
