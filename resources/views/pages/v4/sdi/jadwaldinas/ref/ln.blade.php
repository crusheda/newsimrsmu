...
@section('content')
        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Referensi <b class="text-success link-underline-success text-decoration-underline">Hari Libur Nasional</b>
                </h1>
                ...
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        <div class="btn-group">
                            ...
                            <button class="btn btn-success" onclick="tambah()" data-bs-toggle="tooltip"
                            data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="orderdetailsModalLabel">Tambah <b class="text-success">Hari Libur Nasional</b></h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 mb-3">
                            <div class="form-group">
                                <label class="form-label">Nama <b class="text-primary">Hari Libur Nasional</b> <a class="text-danger">*</a></label>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Hapus <b class="text-danger">Hari Libur Nasional</b>
                    </h5>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        function refresh() {
            ...
            $.ajax({
                url: "/api/v4/sdi/jadwaldinas/ln/table",
                type: 'GET',
                            ...
                            `<tr style='font-size:13px' id='tr_`+item.id+`'>
                                <td class="cell-fit">
                                    <div class="btn-group rounded">
                                        <button class="btn btn-info disabled" onclick="ubah(`+item.id+`)" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true"
                                        title="Ubah Data" disabled><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-danger-transparent" onclick="hapus(`+item.id+`)" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true"
                                        title="Hapus Data"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                                <td class="cell-fit">${formatTanggal(item.tahun,item.bulan,item.tgl)}</td>
                                <td style='white-space: normal !important; word-wrap: break-word;' class='text-primary'>${item.deskripsi}</td>
        ...
        function simpan() {
            ...
            if (tgl == "" || deskripsi == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: '/api/v4/sdi/jadwaldinas/ln/tambah',
                    dataType: 'json',
                    data: {
                        tgl: tgl,
                        deskripsi: deskripsi,
        ...
        function prosesHapus() {
            ...
            if (checkboxHapus == false) {
                ...
                var id = $("#id_hapus").val();
                $.ajax({
                    url: "/api/v4/sdi/jadwaldinas/ln/"+id+"/hapus",
                    type: 'DELETE',
                    success: function(res) {
                        iziToast.success({
                            title: 'Pesan Sukses!',
