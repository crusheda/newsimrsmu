...
@section('content')
    ...
    <div class="container-fluid page-container main-body-container">
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none d-flex align-items-center">
                    Jadwal <b class="text-primary link-underline-primary text-decoration-underline ms-1">Dinas</b> <span class="badge bg-primary-transparent ms-2">Tambah</span>
                </h1>
            ...
            <div class="col-sm-12">
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        <h6 class="mb-0"><button class="btn btn-teal-transparent" onclick="window.location='{{ route('v4.sdi.jadwaldinas') }}'"><i class="fas fa-chevron-left me-2"></i>Kembali</button></h6>
                        <div class="text-end">
                    ...
                    <form action="{{ route('v4.sdi.jadwaldinas.prosesTambah') }}" id="formTambah" class="needs-validation mb-0" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer p-3">
                            <div class="text-end btn-page">
                                <a class="btn btn-link text-dark" id="clear_text" href="javascript:void(0);" onclick="clearInput()">Kosongkan</a>
                                <div class="btn-group">
                                    <a class="btn btn-secondary" id="btn-hapus-jadwal" href="javascript:void(0);" onclick="hapus({{ $list['jadwal']->id }})"><i class="fas fa-trash me-1"></i> Hapus</a>
                                    <a class="btn btn-primary" id="btn-simpan" href="javascript:void(0);" onclick="simpan()"><i class="fas fa-save me-1"></i> Simpan</a>
                                    <a class="btn btn-danger" id="btn-ajukan" href="javascript:void(0);" onclick="ajukan()"><i class="fas fa-stamp me-1"></i> Ajukan / Final</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        function simpan() {
            ...
            $.ajax({
                url: "/api/v4/sdi/jadwaldinas/{{ $list['jadwal']->id }}/shift",
                type: 'GET',
                dataType: 'json',
