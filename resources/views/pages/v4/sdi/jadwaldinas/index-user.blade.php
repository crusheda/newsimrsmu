                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="tombolMenu">
                                <li>
                                    ...
                                    <div class="divider pb-1"></div>
                                    <a class="dropdown-item" href="{{ route('v4.sdi.jadwaldinas.bawahan') }}" id="tombol-verif-bawahan">Verifikasi Bawahan <span class="badge bg-danger ms-2" id="count-bawahan">0</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.shift.forEach((s, index) => {
                        content += `<th class="p-2 text-center" ${index===0?"style='border-left: 3px solid #eaeeaf !important;'":""}>${s.singkat}</th>`;
                    });
