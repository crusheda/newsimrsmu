...
@section('content')
    ...
    <div class="container-fluid page-container main-body-container">
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Rekapitulasi <b class="text-primary link-underline-primary text-decoration-underline">Absensi</b>
                </h1>
        ...
        <div class="row justify-content-center">
            @canany(['admin_kepegawaian', 'admin_kepegawaian_kepala'])
                <div class="col-sm-12">
                    <div class="collapse" id="showIjinManual" style="">
                        <div class="card custom-card">
                            <div class="card-header d-flex align-items-center justify-content-between px-3">
                                <h6 class="mb-0">Form Absensi <a class="text-orange">Ijin Manual</a></h6>
                            </div>
                            <div class="card-body">
                                <div class="row" id="filterTampil">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" onchange="checkJadwalIjin(this.value)" id="jadwal_ijin" style="width: 100%" data-allow-clear="false" data-bs-auto-close="outside" disabled></select>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label class="form-label">Pilih Nama Pegawai <a class="text-danger">*</a></label>
                                            <select class="form-control select2" onchange="checkPegawaiIjin(this.value)" id="pegawai_ijin" style="width: 100%" data-allow-clear="false" data-bs-auto-close="outside" disabled></select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3" id="pilih_ket_ijin" hidden>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="ket_ijin">
                                    ...
                                    <div class="text-end btn-page mt-2">
                                        <button class="btn btn-link text-dark" id="clear_input_ijin" onclick="clearInputIjin()">Kosongkan</button>
            ...
            <div class="col-sm-12" id="table" hidden>
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between px-3">
                        <h6 class="mb-0"><b style="font-size: 1rem">Tabel <a class="text-primary">Riwayat</a></b></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12" id="foto" hidden>
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between px-3">
                        <h6 class="mb-0"><b style="font-size: 1rem">Bukti <a class="text-primary">Foto Absensi</a></b></h6>
                        {{-- <div class="btn-group">
                            <a href="javascript:void(0);" class="avtar avtar-s btn-warning" onclick="showRiwayat()" data-bs-toggle="tooltip"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="modalFotoTitle"></h6>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-link text-dark" data-bs-dismiss="modal">Tutup <i class="fas fa-arrow-right ms-1"></i></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        let devID = @json(Auth::user()->hasRole('karu-it'));
        ...
        function checkBulanIjin(bulan) {
            $.ajax({
                url: "/api/v4/sdi/absensi/ijin/checkBulan/"+bulan,
                type: 'GET',
                dataType: 'json',
        ...
        function checkJadwalIjin(id_jadwal) {
            $.ajax({
                url: "/api/v4/sdi/absensi/ijin/checkJadwal/"+id_jadwal,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    $("#pegawai_ijin").empty();
        ...
        function checkPegawaiIjin(id_jadwal) {
            $.ajax({
                url: "/api/v4/sdi/absensi/ijin/checkPegawai/" + id_jadwal,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    $('#showInfoIjin').empty();
        ...
        function simpanIjin() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/ijin/push`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showDeteksiPerangkat() {
            ...
            // INITIALIZIE
            $.ajax({
                url: `/api/v4/sdi/absensi/deteksiperangkat`,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
        ...
        function showMonitoring() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/monitoring`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showRiwayatLengkap() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/all`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showRekapAbsensiLinda() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/rekapLinda`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showRekapAbsensiLindaDetail() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/rekapLindaDetail`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showRekapCuti() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/getCutiPegawai`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showMonitoringAbsensiHarian() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/getMonitoringAbsensiHarian`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function showBuktiFotoAbsensi() {
            ...
            $.ajax({
                ...
                url: `/api/v4/sdi/absensi/table/getBuktifFotoPegawai`,
                method: 'post',
                data: save,
                cache: false,
                contentType: false,
        ...
        function detail(id) {
            ...
            $.ajax({
                url: `/api/v4/sdi/absensi/${id}/detail`,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    if (res.show) {
        ...
        function ubah(id) {
            ...
            $.ajax(
            {
                url: "/api/v4/sdi/absensi/"+id+"/ubah",
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    if (res.show.jenis == 1) {
        ...
        function prosesUbah() {
            ...
            if (
                ...
                $.ajax({
                    ...
                    url: "/api/v4/sdi/absensi/"+id+"/ubah/proses",
                    method: 'post',
                    data: save,
                    contentType: false,
                    processData: false,
        ...
        function prosesHapus() {
            ...
            if (checkbox == false) {
                ...
                // PROSES
                $.ajax({
                    url: "/api/v4/sdi/absensi/"+id+"/hapus/{{ Auth::user()->id }}",
                    type: 'GET',
                    dataType: 'json',
                    success: function(res) {
                        iziToast.success({
