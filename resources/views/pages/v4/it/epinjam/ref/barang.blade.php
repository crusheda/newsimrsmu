...
@section('content')
    ...
    <div class="modal fade" tabindex="-1" id="modalUbah" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Ubah <b class="text-info">Referensi</b> <b class="text-success">Barang</b></h6>&nbsp;&nbsp;<span class="badge text-bg-warning badge-sm p-1"><a id="show_id_ubah"></a></span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Hapus <b class="text-info">Referensi</b> <b class="text-success">Barang</b>&nbsp;&nbsp;<span class="badge text-bg-danger badge-sm p-1"><a id="show_id_hapus"></a></span>
                    </h5>
                </div>
                <div class="modal-body">
