...
@section('content')
        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Daftar <b class="text-info link-underline-info text-decoration-underline">Barang</b> <b class="text-primary link-underline-primary text-decoration-underline">Pengadaan</b>
                </h1>
                    ...
                    <div class="card-header p-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <h6 class="mb-0">Formulir <b class="text-primary">Tambah Barang</b></h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="alert alert-light shadow-sm rounded">
                                    <small>
                            ...
                            <div class="col-md-7 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="barang" id="barang" class="form-control" placeholder="e.g. Tinta Spidol / Stempel / Bolpoin, etc" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label class="form-label">Upload Lampiran (<b class="text-warning">Optional</b>)</label>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between p-2">
                        <h6 class="mb-0">Tabel <b class="text-secondary">Barang</b></h6>
                        <div class="btn-group">
                            <a href="javascript:void(0);" class="btn btn-sm btn-warning-transparent" onclick="showRiwayat()" data-bs-toggle="tooltip"
                                data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true" title="Segarkan Tabel" id="btn-refresh-tabel">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">
                        Form Ubah ID # <a id="id_edit_show" class="text-secondary"></a>
                    </h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-light mb-3 shadow">
                                <small>
                                    {{-- <i class="ti ti-arrow-narrow-right me-1"></i> <br> --}}
                                    <i class="ti ti-arrow-narrow-right me-1"></i> Isian bertanda (<a class="text-danger">*</a>) berarti wajib diisi<br>
                                    <i class="ti ti-arrow-narrow-right me-1"></i> Batas ukuran file upload maksimal <b class="text-danger">2 mb</b> dan berformat <b>.jpeg/.png/.jpg</b><br>
                        ...
                        <div class="col-md-8 mb-3">
                            <div class="form-group">
                                <label class="form-label">Upload Lampiran Baru (<b class="text-warning">Optional</b>)</label>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" id="btn-ubah" onclick="prosesUbah()"><i class="fa-fw fas fa-save nav-icon me-1"></i> Simpan Perubahan</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // var pathAcBarang = "/api/v4/administrasi/pengadaan/acbarang";
            // $('.typeahead').typeahead({
            ...
            new autoComplete({
                selector: "#barang",
                placeHolder: "e.g. Tinta Spidol / Stempel / Bolpoin, etc",
                data: {
                    src: async (query) => {

                        const response = await fetch("/api/v4/administrasi/pengadaan/acbarang?cari=" + query);
                ...
                events: {
                    input: {
                        selection: (event) => {
                            ...
                            document.querySelector("#barang").value = selection;
                        }
                    }
                }
            });
        ...
        function showRiwayat() {
            ...
            $.ajax({
                url: "/api/v4/administrasi/pengadaan/barang/table",
                type: 'GET',
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(res) {
                    ...
                    res.forEach(item => {
                        ...
                        content += `<td><center><div class='btn-group'>
                                        ...
                                        content += `<li><a href="javascript:void(0);" class="dropdown-item text-${item.filename == null?'muted pe-none':'info'}" onclick="lampiran(${item.filename == null?'':item.id})"><i class="fa-fw fas fa-download me-2"></i> Lampiran</a></li>`;
                        ...
                        if (item.filename == null) {
                            file = `<a href="javascript:void(0);" class="text-dark pe-none"><u>` + item.nama + `</u></a>`;
                        } else {
                            file = `<a href="javascript:void(0);" class="text-primary link-underline-primary text-decoration-underline" onclick="window.open('/pengadaan/barang/download/`+item.id+`')" data-bs-toggle="tooltip"
                        ...
                        content += `<td><h6>${formatRupiah(parseInt(item.harga), 'Rp. ')}</h6></td>`;
                        content += `<td style='white-space: normal !important;word-wrap: break-word;'>
                                        <div class='d-flex justify-content-start align-items-center'>
                                            <div class='d-flex flex-column'>
        ...
        function simpan() {
            ...
            if (
                ...
                $.ajax({
                    ...
                    url: "/api/v4/administrasi/pengadaan/barang/tambah",
                    method: 'post',
                    data: save,
                    cache: false,
                    contentType: false,
        ...
        function ubah(id) {
            $.ajax(
            {
                url: "/api/v4/administrasi/pengadaan/barang/ubah/"+id,
                type: 'GET',
                dataType: 'json',
                success: function(res) {
                    if (res.show.filename == null) {
                        $("#filex_edit_show").empty().append(`<a class="text-danger pe-none">Tidak Ada Lampiran</a>`);
                    } else {
                        $("#filex_edit_show").empty().append(`<a class="text-primary" href="javascript:void(0);" onclick="window.open('/v4/administrasi/pengadaan/barang/download/`+res.show.id+`')"><u>${res.show.title}</u></a>`);
                    }
            ...
            new autoComplete({
                ...
                events: {
                    input: {
                        selection: (event) => {
                            const selection = event.detail.selection.value;
                            document.querySelector("#barang_edit").value = selection;
                        }
                    }
                }
            });
        ...
        function prosesUbah() {
            ...
            if (
                ...
                $.ajax({
                    ...
                    url: "/api/v4/administrasi/pengadaan/barang/ubah/proses",
                    method: 'post',
                    data: save,
                    contentType: false,
                    processData: false,
        ...
        function prosesHapus() {
            ...
            if (checkboxHapus == false) {
                ...
                var id = $("#id_hapus").val();
                $.ajax({
                    url: "/api/v4/administrasi/pengadaan/barang/"+id+"/hapus",
                    type: 'DELETE',
                    success: function(res) {
                        iziToast.success({
                            title: 'Pesan Sukses!',
        ...
        function lampiran(id) {
            if (id) {
                Swal.fire({
                    ...
                    // text: '',
                    imageUrl: '/v4/administrasi/pengadaan/barang/download/' + id,
                    // imageWidth: 400,
                    heightAuto: true,
                    imageHeight: 275,
                    imageAlt: 'Lampiran',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "/v4/administrasi/pengadaan/barang/download/" + id;
                    }
                })
            }
        }
