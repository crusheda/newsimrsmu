<form>
    ...
    <div class="col-md-12 d-flex justify-content-between">
        <button type="button" class="btn btn-info disabled pe-none" onclick="window.location='{{ route('v4.administrasi.eruang') }}'" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true" title="Lihat Kalender Digital" disabled><i class="fas fa-calendar-day me-1"></i> Kalender Digital</button>
