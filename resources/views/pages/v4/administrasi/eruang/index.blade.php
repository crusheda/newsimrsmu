                            ...
                            <div class="tab-pane active" id="pengajuan" role="tabpanel">
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row mb-0" id="loopRuangan"></div>
                                        </div>
                                    ...
                                    <div class="col-md-12 d-flex justify-content-between">
                                        <button type="button" class="btn btn-info" onclick="window.location='{{ route('v4.administrasi.eruang') }}'" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true" title="Lihat Kalender Digital"><i class="fas fa-calendar-day"></i>&nbsp;&nbsp;Kalender Digital</button>
                            ...
                            `<div class="col-xl-3 col-sm-4">
                                <div class="border card p-3" style="margin-bottom: 14px">
                                    <div class="form-check">
                                        <input type="radio" name="ruangan" class="form-check-input input-primary" id="ruangan${item.id}" value="1">
