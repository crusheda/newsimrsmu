...
@section('content')
        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Digital <b class="text-primary link-underline-primary text-decoration-underline">Regulasi</b>
                </h1>
                                ...
                                <div class="position-relative btn-group w-100 h-80 m-t-5">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            @if (Auth::user()->can('admin_regulasi'))
    ...
    <script>
            ...
            $.ajax(
                {
                    ...
                    url: "/api/v4/administrasi/berkas/regulasi/filter",
                    type: 'POST',
                    ...
                    success: function(res) {
                        ...
                        res.show.forEach(item => {
                            ...
                            content += `<td>${item.sah?item.sah:'-'}</td><td style='white-space: normal !important;word-wrap: break-word;'>`
                                        + `<div class='d-flex justify-content-start align-items-center'><div class='d-flex flex-column'><h6 class='mb-0 text-primary'><u><a href='javascript:void(0);' onclick='cetak(` + item.id + `)'>` + item.judul + `</a></u></h6><small class='pe-none text-truncate text-muted' style='white-space: normal !important;word-wrap: break-word;'>`
                                        if (item.unit) {
                                            content += item.unit;
                                        } else {
                                            content += '-';
                            ...
                            content += "</td><td class='text-start'>" + new Date(item.updated_at).toLocaleString("sv-SE") + "</td></tr>";
        ...
        function tambah() {
            ...
            $.ajax(
            {
                url: "/api/v4/administrasi/berkas/regulasi/showtambah",
                type: 'GET',
                dataType: 'json', // added data type
                success: function(res) {
                    res.forEach(item => {
            ...
            if (jns_regulasi == "" || judul == "" || filex == 0) {
                ...
                if (jns_regulasi == '7' || jns_regulasi == '8' || jns_regulasi == '9' || jns_regulasi == '10' || jns_regulasi == '11' || jns_regulasi == '12' || jns_regulasi == '13') {
                    ...
                    $.ajax({
                        ...
                        url: "/api/v4/administrasi/berkas/regulasi/tambah",
                        method: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
        ...
        function prosesUbah() {
            ...
            if (jns_regulasi == "" || tgl == "" || pembuat == "" || judul == "" || unit == "") {
                ...
                $.ajax({
                    ...
                    url: "/api/v4/administrasi/berkas/regulasi/ubah",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
        ...
        function showTotal() {
            ...
            $.ajax(
                {
                url: "/api/v4/administrasi/berkas/regulasi/totalregulasi",
                type: 'GET',
                dataType: 'json', // added data type
                success: function(res) {
