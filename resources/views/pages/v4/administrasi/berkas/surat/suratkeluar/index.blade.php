        ...
        <div class="page-header-breadcrumb mb-3">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <h1 class="page-title fw-medium fs-18 mb-0 pe-none">
                    Berkas <b class="text-danger link-underline-danger text-decoration-underline">Surat Keluar</b>
                </h1>
                ...
                <div class="card custom-card">
                    <div class="card-header d-flex align-items-center justify-content-between py-3">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropmenu-item-info p-2">
                                <li><a class="dropdown-item text-center pe-none" href="javascript:void(0);">Filter Surat</a></li>
                                <li><hr class="dropdown-divider mb-2"></li>
                                <li>
                                    <select class="form-select mb-2 dropdown-item" id="kd_bulan" onchange="getSurat()">
                                ...
                                <li>
                                    <select class="form-select dropdown-item" id="kd_surat" onchange="getSurat()">
                                        <option value="0" selected hidden>Pilih Jenis</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kd_push').change(function() {
                $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/suratkeluar/getkode/"+$(this).val(),
                    type: 'GET',
        ...
        function refresh() {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/suratkeluar/data",
                    type: 'GET',
                    dataType: 'json', // added data type
                    success: function(res) {
                        ...
                        res.show.forEach(item => {
                            ...
                            content += "</td><td class='text-start'>" + new Date(item.updated_at).toLocaleString("sv-SE").substring(0, 19) + "</td><td>";
        ...
        function showAll() {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/suratkeluar/data/all",
                    type: 'GET',
                    dataType: 'json', // added data type
                    success: function(res) {
                        var adminID = "{{ Auth::user()->hasRole('administrator') }}";
        ...
        function getSurat() {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/suratkeluar/filter/"+surat+"/"+bulan+"/"+tahun,
                    type: 'GET',
                    dataType: 'json', // added data type
                    success: function(res) {
                        var adminID = "{{ Auth::user()->hasRole('administrator') }}";
        ...
        function showUbah(id) {
            ...
            $.ajax(
            {
                url: "/api/v4/administrasi/berkas/suratkeluar/data/"+id,
                type: 'GET',
                dataType: 'json', // added data type
                success: function(res) {
                    $('#ubah').modal('show');
        ...
        function ubahAjx() {
            ...
            $.ajax({
                ...
                url: "/api/v4/administrasi/berkas/suratkeluar/ubah",
                method: 'post',
                data: fd,
                contentType: false,
                processData: false,
        ...
        function prosesHapus() {
            ...
            if (checkboxHapus == false) {
                ...
                var id = $("#id_hapus").val();
                $.ajax({
                    url: "/api/v4/administrasi/berkas/suratkeluar/"+id,
                    type: 'DELETE',
                    success: function(res) {
                        iziToast.success({
                            title: 'Pesan Sukses!',
