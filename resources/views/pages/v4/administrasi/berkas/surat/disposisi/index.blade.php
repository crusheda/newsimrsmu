...
@section('content')
    ...
    <script>
        ...
        function refresh() {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/disposisi/data",
                    type: 'GET',
        ...
        function showAll() {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/disposisi/data/all",
                    type: 'GET',
                    dataType: 'json', // added data type
                    success: function(res) {
                        $("#tampil-tbody").empty();
        ...
        function simpan() {
            ...
            if (tujuan == "" || tindak_lanjut == "" || filex == 0) {
                ...
                $.ajax({
                    ...
                    url: "/api/v4/administrasi/berkas/disposisi/simpan",
                    method: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
        ...
        function showDisposisi(id) {
            ...
            $.ajax(
                {
                    url: "/api/v4/administrasi/berkas/disposisi/data/"+id,
                    type: 'GET',
                    dataType: 'json', // added data type
                    success: function(res) {
        ...
        function prosesHapus() {
            ...
            if (checkboxHapus == false) {
                ...
                var id = $("#id_hapus").val();
                $.ajax({
                    url: "/api/v4/administrasi/berkas/disposisi/"+id,
                    type: 'DELETE',
                    success: function(res) {
                        iziToast.success({
                            title: 'Pesan Sukses!',
